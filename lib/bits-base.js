  ...
  class Base extends EventEmitter {
    ...
    initialize() {
      ...
      .then(() => {
        ...
        return this._userManager.load(this._messageCenter, this._baseServer);
      })
      ...
      .then(() => {
        ...
        return this._proxyManager.load(this._messageCenter);
      })
      .then(() => {
      ...
      .then(() => {
        ...
        return this._baseLoadUrl.load('BITS', this._messageCenter);
      })
      .then(() => {
      ...
      .then((server) => {
        ...
        return this._clientManager.load(server);
      })
      .catch((err) => {
