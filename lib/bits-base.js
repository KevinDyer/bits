  ...
  */
  ...
  class Base extends EventEmitter {
    ...
    initialize() {
      ...
      .then(() => this._loggingManager.load(this._messageCenter))
      .then(() => this._scopeManager.load(this._messageCenter))
      .then(() => this._userManager.load(this._messageCenter))
      .then(() => this._authManager.load(this._messageCenter))
    ...
    load() {
      return this._moduleManager.load(this._messageCenter)
