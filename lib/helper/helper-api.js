...
(() => {
  ...
  class HelperApi {
    ...
    remove(helper) {
      return this._messageCenter.sendRequest(HELPER.REQUEST.REMOVE, {scopes: SCOPES}, helper);
    }
    ...
    addRemovedListener(listener) {
      return this._messageCenter.addEventListener(HELPER.EVENT.REMOVED, SCOPES, listener);
    }

    removeRemovedListener(listener) {
      return this._messageCenter.removeEventListener(HELPER.EVENT.REMOVED, listener);
    }
  }
