...
//   } catch (ex) {};
//   try {
//    bitsLogger = require('@lgslabs/bits-logger').getLogger();
//   } catch (ex) {};
...
//       .then(() => this._messageCenter.sendEvent(BASE_LOAD_URL.EVENT.URL_UPDATED, {scopes: []}, this._url))
//       .catch((err) => logger.error('BaseLoadUrl | UPDATE URL: ERROR: ', err))
//       .then(() => this._messageCenter.sendEvent(BASE_LOAD_URL.EVENT.IDENTITY_UPDATED, {scopes: []}, this._identity))
...
//         this._messageCenter.sendEvent(BASE_LOAD_URL.EVENT.URL_UPDATED, {scopes: []}, this._url);
//       }
//     }

//     _getIdentity(metadata) {
...
//         this._messageCenter.sendEvent(BASE_LOAD_URL.EVENT.IDENTITY_UPDATED, {scopes: []}, this._identity);
//       }
//     }
...
//       let id = '';
//       const charset = '01234567890' // numbers
