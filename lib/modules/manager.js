...
(() => {
  ...
  class ModuleManager extends CrudManager {
    ...
    load({messageCenter, clusterService, cryptoManager, keyManager, loggingManager, modulePackageService, scopeManager, userManager}) {
    ...
    _initDataDir() {
      return Promise.all([
        UtilFs.ensureDirectoryExists(this._modulesRootDir),
        UtilFs.ensureDirectoryExists(this._modulesPackagesDir),
        UtilFs.ensureDirectoryExists(this._modulesPackagesDecryptedDir),
        UtilFs.ensureDirectoryExists(this._modulesDir),
        UtilFs.ensureDirectoryExists(this._modulesUploadDir),
      ]);
    }
