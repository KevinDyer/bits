  ...
  class OmgsMessenger extends CrudMessenger {
    ...
    static get REQUEST() {
      return {
        ...
        DELETE: `${OmgsMessenger.TAG} delete`,
    ...
    constructor(manager) {
      ...
      this.addRequestListener(OmgsMessenger.REQUEST.DELETE, OmgsMessenger.WRITE_SCOPES, this._delete.bind(this));
      this.addRequestListener(OmgsMessenger.REQUEST.CURRENT_GET, OmgsMessenger.READ_SCOPES, this._currentGet.bind(this));
      this.addRequestListener(OmgsMessenger.REQUEST.ERROR_DATA_GET, OmgsMessenger.READ_SCOPES, this._errorDataGet.bind(this));

      this.addEmitterEventListener(this._manager, 'upgrade-starting', this._onUpgradeStarting.bind(this));
    }
    ...
    _errorDataGet() {
      return this._manager.getCurrentErrorData();
    }
    ...
    _onUpgradeStarting() {
      return this.sendEvent(OmgsMessenger.EVENT.UPGRADE_STARTING, {scopes: OmgsMessenger.READ_SCOPES}, {});
    }
  }
